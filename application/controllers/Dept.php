...
/*FOR SHOWING DASHBOARD OF DEPTS USERS FOR SUBMITTING SCHEMES AND edit-delete OPTION*/
		...
		public function update_scheme($scheme_id)//THIS "$scheme_id" IS TAKEN FORM "edit_scheme.php" file ON LINE 4// WE USE THIS "$artic_id" PARAMETER ON LINE 72 BELOW IN THIS FILE ITSELF//
		{
