...
<div class="container">
	...
	<td>
			<a href="<?php echo site_url("Auth") ?>" class="btn btn-lg btn-primary">DEPT-WISE LIST asasasas</a>
		</td>
		<td>
            <a href="<?php echo site_url("User/extra") ?>" class="btn btn-lg btn-primary">Dept. Wise Project</a>
        </td>
		<td>
		<a href="<?php echo site_url('Admin') ?>" class="btn btn-lg btn-primary">SHOW ALL SCHEME</a>
		</td>
