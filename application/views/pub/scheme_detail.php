...
<body>
 <button class="btn btn-default" style="float:left"><a href="<?php echo site_url("Auth") ?>">Home</a></button>
<!--
...
<div class="container">
	...
	<div class="col-lg-6"> 
			...
			<h3 style="color:blue;">	
				<?=  //WE RECEIVED THIS "$art_id" OBJECT FROM "public function scheme( $id )" FUNCTION OF "User.php" FILE OF CONTROLLERS FOLDER//
