...
<?php
	...
	echo "Welcome :- <b>" . $_SESSION['dept_id'] . "</b>";
 ?>
</div>
<div class="container-fluid">
  <table>
	<div class="row">
	  <div class="col-lg-6">
		<td>
			<a href="<?php echo site_url("Dept/add_scheme") ?>" class="btn btn-lg btn-primary">SUBMIT SCHEME</a>
		</td>
		<td>
			<a href="<?php echo site_url("Dept/all_approved") ?>" class="btn btn-lg btn-primary">Show All Approved data</a>
		</td>
	   </div>
	</div>
</div>
