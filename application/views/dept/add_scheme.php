...
<?php echo form_hidden('dept_id', $this->session->userdata('dept_id')); ?>
...
<div class="form-group">
  <label class="control-label col-sm-offset-3 col-sm-2" for="fy"><font color="red">**</font>FINANCIAL YEAR<font color="red">**</font></label>
  <div class="col-sm-4 col-md-3">
    ...
    <div class="container">
      <div class="col-lg-12">
        <div class="form-group">
      <label class="col-lg-4 control-label"><font color="red">**</font>SCHEME NAME<font color="red">**</font></label>
      <div class="col-lg-6">
...
?>
 <br>
  ...
  /*Submit and Reset Button*/
   ...
   ?>
<br>
<font color="red">Please Note Red ** Fields are Mandatory
</font>
