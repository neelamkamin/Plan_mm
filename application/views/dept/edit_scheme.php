...
//THIS EXTENSION i.e "{artic->id}" is to provide scheme-id OF scheme TO BE UPDATE
//PLZ SEE SYNTEX= "public function update_scheme($artic_id)" OF ADMIN.PHP FILE ON LINE 60
